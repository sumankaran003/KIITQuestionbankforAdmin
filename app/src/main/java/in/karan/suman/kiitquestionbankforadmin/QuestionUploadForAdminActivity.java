...
public class QuestionUploadForAdminActivity extends AppCompatActivity {

    Button upload;
    Spinner yearField,typeField;
    EditText subjectField,qyearField;

    TextView textViewStatus,branchField;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question_upload_for_admin);
        ...
        branchField = (TextView) findViewById(R.id.branch);
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && ContextCompat.checkSelfPermission(QuestionUploadForAdminActivity.this,
